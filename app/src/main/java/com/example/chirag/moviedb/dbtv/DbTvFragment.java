...
public class DbTvFragment extends Fragment implements DBTvContract.View,
    ...
    private void startNewActivity(int movieId, String tvName, String movieType) {
        Intent intent = new Intent(getContext(), MovieDetailActivity.class);
        intent.putExtra(EXTRA_ID, movieId);
        intent.putExtra(EXTRA_TITLE, tvName);
    ...
    private void setLayout(List<ResultResponse> data, LinearLayout layout, TextView textView,
                           String title) {
        if (isConnected) {
            if (data != null && !data.isEmpty()) {
                ...
                for (final ResultResponse item : data) {
                    View parent = getLayoutInflater().inflate(R.layout.movie_home_poster, layout,
                            false);
                    ...
                    poster.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            String movieType = item.getType();
                            startNewActivity(mMovieId, movieName, movieType);
                        }
                    });
