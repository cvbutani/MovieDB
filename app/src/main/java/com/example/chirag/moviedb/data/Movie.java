...
public final class Movie {
    ...
    @Ignore
    public Movie(@NonNull String mId, @Nullable String mTitle, @Nullable Double mVote, @Nullable String mPoster, @Nullable String mLanguage, @Nullable String mGenre, @Nullable String mBackdropPoster, @Nullable String mOverview, @Nullable String mReleaseDate) {
        this(mId, mTitle, mVote, mPoster, mLanguage, mGenre, mBackdropPoster, mOverview, mReleaseDate, null, null, null);
    }

    @Ignore
    public Movie(@NonNull String mId, @Nullable String mTitle, @Nullable Double mVote, @Nullable String mPoster, @Nullable String mLanguage, @Nullable String mGenre, @Nullable String mBackdropPoster, @Nullable String mOverview, @Nullable String mReleaseDate, @Nullable String mTrailerKey, @Nullable String mReviewAuthor, @Nullable String mReviewContent) {
        this.mId = mId;
        this.mTitle = mTitle;
        this.mVote = mVote;
    ...
    @Ignore
    public Movie(@NonNull String mId, String author, String review) {
        this(mId, null, null, null, null, null, null, null, null, null, author, review);
    }

    @Ignore
    public Movie(@NonNull String mId, String key) {
